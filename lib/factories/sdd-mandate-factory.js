...
module.exports = class SDDMandateFactory {
  constructor (lemonway) {
    ...
    this.SDDMandate.prototype.signDocumentInit = (ip, wallet, _opts) => factory.signDocumentInit(ip, this, wallet, _opts)

    this.signDocumentInit = (ip, document, wallet, _opts) => {
      const opts = _.assign({}, {
        walletIp: ip,
