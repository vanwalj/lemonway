...
module.exports = _.reduce(errors, (reducer, error) => {
  const _e = LemonwayErrorInherit(error.className, error.codes, error.message, error.description)
